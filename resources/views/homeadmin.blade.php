...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="container">
            ...
            <br>
            <div class="row">
                <div class="col-md-4 text-center"><a href="/trajet" class="btn" style="background-color:#F77D0A; color:#fff">Voir la liste des trajets</a>
                </div>
                <div class="col-md-4 text-center"><a href="/chauffeur" class="btn" style="background-color:#F77D0A; color:#fff">Voir la liste des chauffeurs</a>
                </div>
                <div class="col-md-4 text-center"><a href="/passager" class="btn" style="background-color:#F77D0A; color:#fff">Voir la liste des passagers</a>
                </div>
            </div>
            <!-- Outer Row -->
