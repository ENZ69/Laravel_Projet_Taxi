...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href={{ asset('css/dosis-font.css') }} type='text/css'>
    ...
    <body class="antialiased">
                    ...
                    <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                        <div class="navbar-nav ml-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                @if (Route::has('login'))
                                    @auth
                                    <a href="/creationCompte" class="nav-link dropdown-toggle" data-toggle="dropdown"><i class="fa-solid fa-user"></i> {{ Auth::user()->name }}</a>
                                    <div class="dropdown-menu rounded-0 m-0">
            ...
            <div id="header-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="w-100" src="/img/Sans titre-1.jpg" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 900px;">
                                <h4 class="text-white text-uppercase mb-md-3">Bienvenue chez Faster</h4>
                                <h6 class="display-1 text-white mb-md-4">Le vtc local qui vous accompagne dans tous vos trajets.</h6>
                                @if (Route::has('login'))
                                    @auth
                                    @if(Auth::user()->roles()->where('nom', 'passager')->exists())
                                        <a href="/accueil-passager" class="btn btn-primary py-md-3 px-md-5 mt-2">Passer Commande</a>
                                    @endif
                                    @if(Auth::user()->roles()->where('nom', 'chauffeur')->exists())
                                        <a href="/accueil-chauffeur" class="btn btn-primary py-md-3 px-md-5 mt-2">Voir les commande en attente Commande</a>
                                    @endif
                                    @if(Auth::user()->roles()->where('nom', 'admin')->exists())
                                        <a href="/accueil-admin" class="btn btn-primary py-md-3 px-md-5 mt-2">Tableau de bord</a>
                                    @endif
                                    @else
                                        <a href="{{ route('login') }}" class="btn btn-primary py-md-3 px-md-5 mt-2">Se Connecter</a>
                                    @endauth
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 900px;">
                                <h4 class="text-white text-uppercase mb-md-3">Bienvenue chez Faster</h4>
                                <h1 class="display-1 text-white mb-md-4">Rapidité, Confort et Sécurité.</h1>
                                <a href="/Authentification" class="btn btn-primary py-md-3 px-md-5 mt-2">Passer Commande</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid py-5">
            <div class="container">
                <!-- About Start -->
                <h2 class="row-title" style="color:#F77D0A">Comment ça marche ?</h2>
                <div class="row me-row content-ct">
                    <div class="col-md-4 feature">
                    <i class="fa-sharp fa-solid fa-mobile-screen-button fa-6x" style="color:#016cc7;"></i>
                    <br>
                    <br>
                    <p style="font-weight:600; color:black;">Activez l’application Faster.
                    ...
                    <div class="col-md-4 feature">
                    <i class="fa-solid fa-car-side fa-6x" style="color:#016cc7;"></i>
                    <br>
                    <br>
                    <p style="font-weight:600; color:black;">Votre chauffeur Faster,
                        vous récupère et vous
                        dépose en toute sécurité à
                        la destination indiquée.</p>
                    </div>
                    <div class="col-md-4 feature">
                    <i class="fa-sharp fa-solid fa-file-invoice-dollar fa-6x" style="color:#016cc7;"><i class="fa-solid fa-star"></i></i>
                    <br>
                    <br>
                    <p style="font-weight:600; color:black;">Recevez votre facture et
        ...
        <section class="showcase" style="background-color:rgb(239, 238, 238);">
            <div class="container p-0">
                ...
                <br>
                <br>
                <h2 class="row-title" style="color:#F77D0A;">A propos de Faster.</h2>
                <br>
                <br>
                <div class="row g-0">
                    ...
                    <div class="col-lg-6 order-lg-1 my-auto showcase-text">
                        <h2>Le meilleur choix de transport
                            ...
                            <br>
                        <p class="lead mb-0" style="color:black;">Faster est le service VTC à la demande qui
                ...
                <br>
                <br>
                <h2 class="row-title" style="color:#F77D0A">Faster Business</h2>
                <br>
                <br>
                <div class="row g-0">
                    <div class="col-lg-6 text-white showcase-img" style="background-image: url('/img/dan-gold-kARZuSYMfrA-unsplash.jpg')"></div>
                    <div class="col-lg-6 my-auto showcase-text">
                        <h2>Simplifiez vos déplacements professionnels
                            ainsi que ceux de vos collaborateurs.</h2>
                            <br>
                        <p class="lead mb-0" back-to-top>Nos solutions Faster Business
        ...
        <div class="container-fluid bg-dark py-4 px-sm-3 px-md-5">
            <p class="mb-2 text-center text-body">&copy; <a href="/">Taxibokko</a>. All Rights Reserved.</p>
